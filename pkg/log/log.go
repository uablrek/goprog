...
// NewContext returns a context with a logr.Logger based on the passed
// zap.Logger.  If the passed context already contains a logr.Logger
// it is returned without modifications.
...
// Defered functions will not be called, so Fatal() should be avoided if
// possible.
